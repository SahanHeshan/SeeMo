    ...
    return (
        <section className="bg-background py-16">
            <div className="mx-auto max-w-5xl px-6">
                {/* <h2 className="text-center text-lg font-medium">Blockchain stands as the most reliable decentralized technology—and it’s paving the way for the future.</h2> */}
