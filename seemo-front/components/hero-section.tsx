        ...
        <section>
          <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
            <div className="relative z-10 mx-auto max-w-4xl text-center">
              ...
              >
                QR enabled, decentralized authentication built on Cardano for
                counterfeit proof, trust worthy sourcing—no centralized
                database, total transparency.
              </TextEffect>
              ...
              >
                ...
                <div
                  aria-hidden
                  className="bg-radial from-primary/50 dark:from-primary/25 relative mx-auto mt-32 max-w-7xl to-transparent to-55% text-left"
                >
                  <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-12">
                    {/* Unit 1 */}
